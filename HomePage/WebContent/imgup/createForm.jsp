...
<div class="container">
<h1 class="col-sm-offset-1 col-sm-10" style="text-align: center">사진 등록</h1>
<br><br><br><br><br>
  <form class="form-horizontal" method="post" action="createProc.jsp" enctype="multipart/form-data">
	...
	<div class="form-group">
	  <label class="control-label col-sm-4" for="fname">사진</label>
		<div class="col-sm-4">
		  <input type="file" name = "fname" id="fname" class="form-control" accept=".jpg,.png,.gif">
		</div>
	</div>
