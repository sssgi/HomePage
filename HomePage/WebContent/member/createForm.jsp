  ...
  <script type="text/javascript">
  	function idCheck(id){
  		if(id==""){
  			...
  			var url="idProc.jsp";
  			url +="?id="+id;
  			wr = window.open(url,"아이디검색","width=300,height=300");
...
<h1 class="col-sm-offset-2 col-sm-10" >회원가입</h1>
 ...
 <form class="form-horizontal" action="prcreateProc.jsp" method="post" name="frm" onsubmit="return incheck(this)" enctype="multipart/form-data">
